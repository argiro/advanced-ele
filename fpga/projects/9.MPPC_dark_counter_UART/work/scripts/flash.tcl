...
#
#                     vivado% source ./scripts/flash.tcl
#
# [Version]        1.0
# [Revisions]      22.05.2016 - Created
#-----------------------------------------------------------------------------------------------------
...
set BINFILE  ${OUT_DIR}/bitstream/${TOP}.bin ;     ## **WARN: the .bin file is required to program the external memory !
