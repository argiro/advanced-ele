...
set_property -dict {PACKAGE_PIN D9 IOSTANDARD LVCMOS33} [get_ports {Bt[0]}]
set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports {Bt[1]}]
set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS33} [get_ports {Bt[2]}]
set_property -dict {PACKAGE_PIN B8 IOSTANDARD LVCMOS33} [get_ports {Bt[3]}]
