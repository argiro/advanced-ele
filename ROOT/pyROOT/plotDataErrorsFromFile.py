...
#-----------------------------------------------------------------------------------------------------
# [Filename]      plotDataErrorsFromFile.py
# [Project]       Advanced Electronics Laboratory course
# [Author]        Luca Pacher - pacher@to.infn.it
# [Language]      Python/ROOT
# [Created]       May 15, 2017
# [Modified]      May 15, 2017
# [Description]  Plot a set of experimental data with errors from text file
# 
...
from ROOT import TGraphErrors, gPad, gStyle, TFile


## create a TGraph object from file

## blank-separated values
gr = TGraphErrors("dataErrors.dat")                              # this default is equivalent to TGraphErrors("data.dat", "%lg %lg %lg %lg") 
#gr = TGraphErrors("dataErrors.dat", "%lg %lg %lg %lg")          # **NOTE: %lg is C-syntax for long-double

## comma-separated values
#gr = TGraphErrors("dataErrors.csv", "%lg , %lg")                # the more general syntax is "%lg charSeparator %lg" e.g. "%lg ; %lg"
gr.SetName("gr")
